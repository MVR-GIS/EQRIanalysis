#' @title Plot Question by Design Team
#' @description Plot question by Design Team. 
#'   or Military).
...
#'
plot_question_by_design_team <- function(questions_df, responses_df, question_number) {
