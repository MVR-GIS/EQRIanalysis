#' @title Plot Question by Design Strategy
#' @description Plot question by Design Strategy. 
#'   or Military).
...
#'
plot_question_by_design_strat <- function(questions_df, responses_df, question_number) {
