#' @title Plot Indicator by USACE Program Type
#' @description Plot indicator by USACE Program Type.
...
#'
plot_indicator_by_type <- function(indicators_df, indicator_name) {
